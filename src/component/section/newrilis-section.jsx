           ...
           <section className="h-1/4 w-full bg-bl mt-5 pl-5 md:mt-10 text-white mb-5 md:px-20" >
            <div className="">
                <div className="flex flex-col gap-5 h-full w-full relative">
                    ...
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="0" baru/>     
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="27" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="28" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="29" top/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="30" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="31" baru />    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="1" top/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="22" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="13" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="4" top/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="10" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="25" baru/>    
                    <CardPortrait title="Satu" setDetailData={setDetailData} indexx="7" baru/>    
                    </div>
                 </div>
             </div>
            </section> 
