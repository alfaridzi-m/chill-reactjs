            ...
            <div  style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0), #151515), url(${Image})` }} className="bg-cover bg-center h-full text-white">
                <div className="h-full flex flex-col align-bottom justify-end px-5 py-10 md:p-20 lg:p-40 ">
                    ...
                    <div className="flex flex-row gap-2 items-center mt-6 relative"> 
                        <button className="bg-[#0F1E93] text-xs md:text-base rounded-4xl px-6 py-2"><p>Mulai</p></button>
                        <button className="bg-[#22282A] text-xs md:text-base rounded-4xl px-6 py-2 flex flex-row items-center gap-3">
                            <FontAwesomeIcon icon={faCircleInfo} />
                            <p>Selengkapnya</p>
                            </button>
                        <div className="border-1 border-gray-400 h-full rounded-full text-xs md:text-base py-1 px-2">
                            <p>18+</p>
                        </div>
                        <FontAwesomeIcon icon={faVolumeXmark} className="absolute right-2" />
                    </div>
                </div>
            </div>
        </section>
